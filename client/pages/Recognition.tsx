...
export default function Recognition() {
  ...
  const [recognitionModel, setRecognitionModel] = useState<RecognitionModel>("arcface");
  ...
  const handleProcess = async () => {
    ...
    // Simulate processing with selected models
    setTimeout(() => {
        ...
        faces: [
          {
            ...
            age: "25-35",
            gender: "Female",
            embedding: "Generated by " + recognitionNames[recognitionModel]
          }
        ],
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-6 space-y-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-semibold text-slate-900">Model Settings</h3>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="efficientb3">EfficientNet-B3 (Efficient)</option>
                  </select>
